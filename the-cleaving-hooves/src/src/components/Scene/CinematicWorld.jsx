...
export const CinematicWorld = ({ scrollProgress, mouseOffset }) => {
  ...
  return (
    <>
      ...
      {/* Chapter 2: Warband Frame & Poster */}
      <group ref={warbandGroupRef} position={[0, 0, -20.0]}>
        <mesh position={[0, 0, 0]}>
          <planeGeometry args={[13.33, 7.5]} />
          <meshStandardMaterial
            map={teamPosterTex}
            roughness={0.4}
            metalness={0.3}
        ...
        <mesh position={[0, -3.9, 0.08]}>
          <boxGeometry args={[13.8, 0.3, 0.3]} />
        ...
        <mesh position={[-6.8, 0, 0.08]}>
          <boxGeometry args={[0.3, 8.0, 0.3]} />
          <meshStandardMaterial color="#5c442e" metalness={0.88} roughness={0.35} />
        </mesh>
        <mesh position={[6.8, 0, 0.08]}>
          <boxGeometry args={[0.3, 8.0, 0.3]} />
